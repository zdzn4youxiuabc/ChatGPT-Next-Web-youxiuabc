...
git clone https://github.com/zdzn4youxiuabc/ChatGPT-Next-Web-youxiuabc.git /data/gpt/ChatGPT-Next-Web-youxiuabc.git
#cd ChatGPT-Next-Web
cd /data/gpt/ChatGPT-Next-Web-youxiuabc.git
yarn install
